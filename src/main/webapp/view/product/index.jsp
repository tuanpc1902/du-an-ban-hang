                    ...
                    <nav class="header__navbar">
                        ...
                        <ul class="header__navbar-list">
                            ...
                            <li class="header__navbar-item header__navbar-item--strong header__navbar-item--separate"
                                id="dangky" onclick="dangky()">
                                Đăng ký
                            </li>
                            <li class="header__navbar-item header__navbar-item--strong" id="dangnhap"
                                onclick="dangnhap()">Đăng nhập</li>
                    ...
                    <div class="header__with-search">
                        ...
                        <div class="header__search">
                            <div class="header__search-input-wrap">
                                <form action="/index/search" class="header__search-input" style="height: 100%"
                                    method="post">
                                    <input type="text" name="keywords" value="${keywords}" class="header__search-input"
                                    ...
                                    <ul class="header__cart-list-item">
                                        <c:forEach var="item" items="${cart.items}">
                                            <li class="header__cart-item">
                                                <img src="https://cf.shopee.vn/file/f90281bc67a578f781df13cf3e9b0ad2_tn"
                            ...
                            <div class="grid__column-10">
                                <div class="boder-container">
                                    <div class="product__heading">
                                        <div class="quantity">
                                            <h3 class="product__quantity">${page.totalElements} Sản phẩm</h3>
                                            ...
                                            <div class="select-input">
                                                ...
                                                <ul class="select-input__list">
                                                    ...
                                                    <li class="select-input-item">
                                                        <a href="/product/sort?field=price"
                                                            class="select-input-link">Giá thấp đến cao</a>
                                                    </li>
                                                    <li class="select-input-item">
                                                        <a href="/product/sort?field=price"
                                                            class="select-input-link">Giá cao đến thấp</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="header__search search-heading">
                                            <div class="header__search-input-wrap">
                                                <form action="/product/search" class="header__search__form"
                                        ...
                                        <a href="/product/create-product" class="btn btn--primary btn__add"><i
                                                class="fas fa-plus"></i>&nbsp;Thêm sản phẩm mới</a>
                                        <div class="home__filter__page">
                                            <span class="home__filter__page-num">
                                                <span
                                                    class="home__filter__page-current num__page">${page.number+1}</span>/${page.totalPages}
                                            </span>

                                            <div class="home__filter__page-control">
                                                <a href="/product/?p=${page.number-1}"
                                                    class="home__filter__page-btn">
                                                            ...
                                                            <td class="table__edit">
                                                                <%-- <a href="/cart/add/${item.id}">Add To Cart</a> --%>
                                                                    <a href="/product/edit/${item.id}"><i
                                                                            class="far fa-edit"
                                                                            title="Chỉnh sửa"></i></a>
                                                                    <a href="/product/delete/${item.id}"><i
