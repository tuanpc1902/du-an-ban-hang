                ...
                <div class="grid">
                    <div class="grid__row">
                        <div class="container__edit">
                            <div class="border__form" style="border: none; margin: 50px 0;">
                                <form:form action="/product/edit" modelAttribute="item" class="form__edit">
                                    <div class="header__edit">
                                        <div class="edit__heading">
                                            <h3 class="edit__title">Chỉnh sửa thông tin sản phẩm (${item.name })</h3>
                                        </div>
                                    </div>
                                    <br>
                                    <form:input type="text" path="name" class="name" placeholder="Tên sản phẩm" />
                                    <br>
                                    <form:input type="number" path="price" class="price" name="" id=""
                                        placeholder="Giá sản phẩm" />
                                    <br>
                                    <input type="radio" path="available" name="available" id="" value="1"> Còn hàng
                                    <input type="radio" path="available" name="available" id="" value="0"> Hết hàng
                                    <br>
                                    <form:select path="category">
										<form:option value="${item.category }"></form:option>
									</form:select>
                                    <br>
                                    <form:input path="image" name="image" type="file" />
                                    <br>
                                    <button formaction="/product/update" class="btn btn--primary">Lưu</button>
                                </form:form>
                            </div>
                        </div>
                    </div>
