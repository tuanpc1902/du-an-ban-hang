                            ...
                            <div class="header__cart-warp">
                                ...
                                <div class="header__cart-list">
                                    ...
                                    <ul class="header__cart-list-item">
                                        <li class="header__cart-item">
                                            ...
                                            <div class="header__cart-item-info">
                                                ...
                                                <div class="header__cart-item-head">
                                                    <h4 class="header__cart-item-name">Kính cường lực iphone 15D REMAX
                                                        full
                                                        màn hình</h4>
                                        ...
                                        <li class="header__cart-item">
                                            <img src="https://cf.shopee.vn/file/a8f1d892db886a0764ca6b9f40ac7b05_tn"
                                                alt="" class="header__cart-img">
                                            <div class="header__cart-item-info">
                                                <!-- head -->
                                                <div class="header__cart-item-head">
                                                    <h4 class="header__cart-item-name">CPU Intel Core i3 10100F 3.6GHz
                                                        up to
                                                        4.3GHz</h4>
                                                    <div class="header__card-item-price-warp">
                                        ...
                                        <li class="header__cart-item">
                                            <img src="https://cf.shopee.vn/file/32fc89620ab7094138f47eb40eb7b0e1_tn"
                                                alt="" class="header__cart-img">
                                            <div class="header__cart-item-info">
                                                <!-- head -->
                                                <div class="header__cart-item-head">
                                                    <h4 class="header__cart-item-name">Laptop ASUS ROG G15
                                                        GA502IU-AL007T
                                                        R7-4800HS</h4>
                                                    <div class="header__card-item-price-warp">
                ...
                <div class="grid">
                    <div class="grid__row">
                        ...
                        <div class="container__edit">
                            <div class="boder__form" style="border: none; margin: 50px 0;">
                                <form:form action="/product/edit" modelAttribute="item" class="form__edit">
                                    <div class="header__edit">
                                        <div class="edit__heading">
                                            <h3 class="edit__title">Thêm sản phẩm mới</h3>
                                        </div>
                                    </div>
                                    <br>
                                    <!-- <form:input type="text" path="name" class="name" placeholder="Tên sản phẩm" />
                            <br>
                            <form:input type="number" path="price" class="price" name="" id="" placeholder="Giá sản phẩm" />
                            <br>
                            <select name="" class="category" id="">
                                <option value="">Danh mục</option>
                                <option value="">Laptop</option>
                                <option value="">Điện thoại</option>
                                <option value="">Chuột, bàn phím</option>
                                <option value="">Quạt, tản nhiệt</option>
                                <option value="">Máy tính bàn</option>
                                <option value="">Tai nghe Gaming</option>
                                <option value="">Nguồn máy tính</option>
                                <option value="">Case máy tính</option>
                                <option value="">USB & ổ cứng</option>
                            </select>
                            <br>
                            <form:input path="image" type="file" />
                            <br>
                            <button formaction="/product/edit" class="btn btn--primary">Lưu</button>
                        </form:form> -->
                            </div>
                        </div>
                    </div>
