<%@ page pageEncoding="utf-8" %>
    <%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
        ...
        <head>
            ...
            <link rel="stylesheet" href="/view/assets/css/detail.css">
            ...
            <script src="/view/assets/js/info.js"></script>
                                            ...
                                            <li class="header__notify-item">
                                                <a href="" class="header__notify-link">
                                                    ...
                                                    <div class="header__notify-info">
                                                        ...
                                                        <spam class="header__notify-descriotion">🚛 Freeship đến 15K đơn
                                                            từ 50K
                                                            🔥 Mã giảm HOT 10K
                                                            cho đơn 0Đ 🙌 Mã sẵn trong ví - chốt đơn chốt
                                                            đơn!</spam>
                                                    </div>
                                                </a>
                                            </li>
                                                ...
                                                <a href="" class="header__notify-link">
                                                    ...
                                                    <div class="header__notify-info">
                                                        <span class="header__notify-name">AirPay tặng bạn Voucher
                                                            APAPR2GIFT1
                                                            giảm 40K</span>
                                                        <spam class="header__notify-descriotion">⚡ Nhanh tay mở ví.
                                                            Shopping hết
                                                            ý! 🎁 Vào rinh
                                                            ngay Voucher giảm đến 40K!</spam>
                                                    </div>
                                                </a>
                                            </li>
                                        </ul>
                                            ...
                                            <li class="header__cart-item">
                                                ...
                                                <div class="header__cart-item-info">
                                                    ...
                                                    <div class="header__cart-item-head">
                                                        <h4 class="header__cart-item-name">
                                                            Kính cường lực iphone 15D REMAX full màn hình
                                                        </h4>
                                    ...
                                    <div class="detail">
                                        <div class="grid__column-4">
                                            <div class="container">
                                                <div class="mySlides">
                                                    ...
                                                    <img src="/view/assets/img/laptop-asus.jpg" style="width:100%">
                                                </div>

                                                <div class="mySlides">
                                                    <div class="numbertext">2 / 6</div>
                                                    <img src="/view/assets/img/img-product/laptop-asus-1.jpg"
                                                        style="width:100%">
                                                </div>

                                                <div class="mySlides">
                                                    <div class="numbertext">3 / 6</div>
                                                    <img src="/view/assets/img/img-product/laptop-asus-2.jpg"
                                                        style="width:100%">
                                                </div>

                                                <div class="mySlides">
                                                    <div class="numbertext">4 / 6</div>
                                                    <img src="/view/assets/img/img-product/laptop-asus-3.jpg"
                                                        style="width:100%">
                                                </div>

                                                <div class="mySlides">
                                                    <div class="numbertext">5 / 6</div>
                                                    <img src="/view/assets/img/img-product/laptop-asus-4.jpg"
                                                        style="width:100%">
                                                </div>

                                                <div class="mySlides">
                                                    <div class="numbertext">6 / 6</div>
                                                    <img src="/view/assets/img/img-product/laptop-asus-5.jpg"
                                                        style="width:100%">
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="column">
                                                        <img class="demo cursor" src="/view/assets/img/laptop-asus.jpg"
                                                            style="width:100%" onclick="currentSlide(1)"
                                                            alt="The Woods">
                                                    </div>
                                                    <div class="column">
                                                        <img class="demo cursor"
                                                            src="/view/assets/img/img-product/laptop-asus-1.jpg"
                                                            style="width:100%" onclick="currentSlide(2)"
                                                            alt="Cinque Terre">
                                                    </div>
                                                    <div class="column">
                                                        <img class="demo cursor"
                                                            src="/view/assets/img/img-product/laptop-asus-2.jpg"
                                                            style="width:100%" onclick="currentSlide(3)"
                                                            alt="Mountains and fjords">
                                                    </div>
                                                    <div class="column">
                                                        <img class="demo cursor"
                                                            src="/view/assets/img/img-product/laptop-asus-3.jpg"
                                                            style="width:100%" onclick="currentSlide(4)"
                                                            alt="Northern Lights">
                                                    </div>
                                                    <div class="column">
                                                        <img class="demo cursor"
                                                            src="/view/assets/img/img-product/laptop-asus-4.jpg"
                                                            style="width:100%" onclick="currentSlide(5)"
                                                            alt="Nature and sunrise">
                                                    </div>
                                                    <div class="column">
                                                        <img class="demo cursor"
                                                            src="/view/assets/img/img-product/laptop-asus-5.jpg"
                                        ...
                                        <div class="grid__column-6">
                                            <div class="detail__heading">
                                                <h3 class="detail__title">${item.name }</h3>
                                            </div>
                                            ...
                                            <div class="detail__footer">
                                                <a href="/cart/add/${item.id}" class="btn btn--primary"><i
                                                        class="fas fa-cart-plus" style="margin-right: 10px;"></i>Thêm
                                                    Vào Giỏ Hàng</a>
                        ...
                        <div class="grid__row">
                            ...
                            <div class="grid__column-2-4">
                                ...
                                <div class="footer__download">
                                    <img class="footer__download__pr" src="/view/assets/img/qr_code.png"
                                        alt="qr_code" />
                    ...
                    <div class="footer__bottom">
                        <div class="grid">
                            <p class="footer__text">
                                © 2021 - Bản quyền thuộc về Công ty PS14046 - Phạm Công Tuấn
                            </p>
                        </div>
                    </div>
                </footer>
