...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/view/assets/fronts/themify-icons/themify-icons.css">
...
<body>
            ...
            <nav class="header__navbar">
                ...
                <ul class="header__navbar-list">
                                ...
                                <li class="header__notify-item header__notify-item--viewed">
                                    <a href="" class="header__notify-link">
                                        ...
                                        <div class="header__notify-info">
                                            <span class="header__notify-name">Phạm Công Tuấn ơi! Vào săn mã FREESHIP đơn 0Đ</span>
                                ...
                                <li class="header__notify-item">
                                    <a href="" class="header__notify-link">
                                        ...
                                        <div class="header__notify-info">
                                            ...
                                            <spam class="header__notify-descriotion">🚛 Freeship đến 15K đơn từ 50K
                                ...
                                <li class="header__notify-item">
                                    <a href="" class="header__notify-link">
                                        <img src="https://cf.shopee.vn/file/9bd80298caf8e9aacb5f1c2aa4487eb8_tn"
                                            alt="" class="header__notify-img">
                                        <div class="header__notify-info">
                                            <span class="header__notify-name">AirPay tặng bạn Voucher APAPR2GIFT1 giảm 40K</span>
                                            <spam class="header__notify-descriotion">⚡ Nhanh tay mở ví. Shopping hết ý! 🎁 Vào rinh ngay Voucher giảm đến 40K!</spam>
                                        </div>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <li class="header__navbar-item header__navbar-user">
                        <img src="https://yt3.ggpht.com/yti/ANoDKi5qmmdVIHTLjd9HvoOsaNhCF5AeciR93OFy-tcTuA=s88-c-k-c0x00ffffff-no-rj-mo" alt="" class="header__navbar-user-img">
            ...
            <div class="header__with-search">
                ...
                <div class="header__search">
                    ...
                    <button class="header__search-btn">
                        <div class="header__search-btn-icon fas fa-search"></div>
                    </button>
                </div>
                <!-- Cart -->
                        ...
                        <div class="header__cart-list">
                            ...
                            <ul class="header__cart-list-item">
                                <li class="header__cart-item">
                                    <img src="https://cf.shopee.vn/file/f90281bc67a578f781df13cf3e9b0ad2_tn" alt=""
                                        class="header__cart-img">
                                    <div class="header__cart-item-info">
                                        <!-- head -->
                                        <div class="header__cart-item-head">
                                            <h4 class="header__cart-item-name">Kính cường lực iphone 15D REMAX full
                                                màn hình</h4>
                                            <div class="header__card-item-price-warp">
                                                <span class="header__cart-item-price">19.000đ</span>
                                ...
                                <li class="header__cart-item">
                                    <img src="https://cf.shopee.vn/file/a8f1d892db886a0764ca6b9f40ac7b05_tn" alt=""
                                        class="header__cart-img">
                                    <div class="header__cart-item-info">
                                        <!-- head -->
                                        <div class="header__cart-item-head">
                                            <h4 class="header__cart-item-name">CPU Intel Core i3 10100F 3.6GHz up to
                                                4.3GHz</h4>
                                            <div class="header__card-item-price-warp">
                                                <span class="header__cart-item-price">2.978.000đ</span>
                                                <span class="header__cart-item-mutiply">x</span>
                                ...
                                <li class="header__cart-item">
                                    <img src="https://cf.shopee.vn/file/32fc89620ab7094138f47eb40eb7b0e1_tn" alt=""
                                        class="header__cart-img">
                                    <div class="header__cart-item-info">
                                        <!-- head -->
                                        <div class="header__cart-item-head">
                                            <h4 class="header__cart-item-name">Laptop ASUS ROG G15 GA502IU-AL007T
                                                R7-4800HS</h4>
                                            <div class="header__card-item-price-warp">
                                                <span class="header__cart-item-price">28.900.000đ</span>
                                                <span class="header__cart-item-mutiply">x</span>
                                                <span class="header__cart-item-qnt">1</span>
                                            </div>
                                        </div>
                    ...
                    <div class="grid__column-2">
                        <nav class="category">
                            ...
                            <ul class="category-list">
                                ...
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Chuột, bàn phím</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Quạt, tản nhiệt</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Máy tính bàn</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Tai nghe Gaming</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Nguồn máy tính</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Case máy tính</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">USB & ổ cứng</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="grid__column-10">
                        <div class="boder-container">
                            <div class="product__heading">
                                <div class="quantity">
                                    <h3 class="product__quantity">0 Product</h3>
                                    <div class="product__quantity__br">
                                        <span class="product__br">
                                        0 / 1000
                                        </span>
                                    </div>
                                </div>
                                <div class="home__filter filter__price">
                                    <div class="select-input">
                                        ...
                                        <ul class="select-input__list">
                                            ...
                                            <li class="select-input-item">
                                                <a href="#" class="select-input-link">Giá cap đến thấp</a>
                                            </li>
                                        </ul>
                                    </div>    
                                </div>
                                <div class="header__search search-heading">
                                    <div class="header__search-input-wrap">
                                        <input type="text" class="header__search-input" placeholder="Nhập tên sản phẩm cần tìm !">
                                    </div>
                                </div>
                                <button class="btn btn--primary btn__add"><i class="fas fa-plus"></i>&nbsp;Thêm sản phẩm mới</button>
                                <div class="home__filter__page">
                                    <span class="home__filter__page-num">
                                        <span class="home__filter__page-current num__page">1</span>/14
                                    </span>
    
                                    <div class="home__filter__page-control">
                                        <a href="#" class="home__filter__page-btn home__filter__page-btn-disable">
                                            <i class="home__filter__page-icon fas fa-angle-left"></i>
                                        </a>
                                        <a href="#" class="home__filter__page-btn">
                                            <i class="home__filter__page-icon fas fa-angle-right"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody class="table__body">
                                            <c:forEach var="item" items="${page.content}">
                                                <tr class="table__tr">
                                                    <td>${item.id}</td>
                                                    <td>${item.name}</td>
                                                    <td><img src="/view/assets/img/$(item.image)" alt=""></td>
                                                    <td>${item.price}</td>
                                                    <td>${item.createDate}</td>
                                                    <td>${item.image }</td>
                                                    <td class="table__edit">
                                                        <a href=""><i class="far fa-edit"></i></a>
                                                        <a href=""><i class="trash__icon far fa-trash-alt"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                            ...
                            <!-- <ul class="pagination home__product__pagination">
                                <li class="pagination__item">
                                    <a href="/product/page?p=0" class="pagination__item__link">
                                        <i class="pagination__item__icon fas fa-angle-double-left"></i>
                                    </a>
                                </li>
                                <li class="pagination__item">
                                    <a href="/product/page?p=${page.number-1}" class="pagination__item__link">
                                        <i class="pagination__item__icon fas fa-angle-left"></i>
                                    </a>
                                </li>
                                <li class="pagination__item pagination__item--active">
                                   <a href="#" class="pagination__item__link ">${page.number+1}</a>
                                </li>
                                <li class="pagination__item">
                                    <a href="/product/page?p=${page.number+1}" class="pagination__item__link">
                                        <i class="pagination__item__icon fas fa-angle-right"></i>
                                    </a>
                                </li>
                                <li class="pagination__item">
                                    <a href="/product/page?p=${page.totalPages-1}" class="pagination__item__link">
                                        <i class="pagination__item__icon fas fa-angle-double-right"></i>
                                    </a>
                                </li>
                            </ul> -->
                        </div>
    ...
    <footer class="footer">
                ...
                <div class="grid__column-2-4">
                    ...
                    <div class="footer__download">
                        ...
                        <div class="footer__download__apps">
                            <a class="footer__download__apps__link" href="https://itunes.apple.com/VN/app/id959841449?mt=8">
                                <img src="/view/assets/img/app_store.png" alt="app-store" class="footer__download__apps__img">
                            </a>
                            <a class="footer__download__apps__link" href="https://play.google.com/store/apps/details?id=com.shopee.vn&referrer=af_tranid%3Drsx9V4J79OX3NH5LwyqLcw%26pid%3DOrganicA%26c%3Dlp_home_and1">
                                <img src="/view/assets/img/gg_play.png" alt="gg-play" class="footer__download__apps__img">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer__bottom">   
            <div class="grid">
                <p class="footer__text">© 2021 - Bản quyền thuộc về Công ty TNHH Một Mình T** !</p>
            </div>
        </div>
    </footer>
</body>
